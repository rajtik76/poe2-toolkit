/**
 * `@poe2-tree/core` — headless geometry engine for the Path of Exile 2 passive
 ...
 * official export lives in the `@poe2-tree/core/ggg` subpath, so the engine
...
// Data-source adapters live in their own subpaths (e.g. `@poe2-tree/core/ggg`)
